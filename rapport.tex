...
Une fois cet arbre obtenu, l'algorithme d'extraction des itemsets fréquents suivant peut être appelé. Nous le décrivons dans la section suivante. \\
\newpage
\subsection{Extraction des itemsets fréquents}
